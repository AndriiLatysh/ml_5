...
print("Train size:", X_train_count)
print("Test size:", X_test_count)
...
CNN_model.add(keras_layers.MaxPool2D(pool_size=(2, 2)))
...
print("Training time:", round((ending_time - starting_time)))

CNN_model_evaluation = CNN_model.evaluate(X_test, y_test, verbose=0)

print("Cross-validated accuracy: ", CNN_model_evaluation[1])
